...
Please read Assignment-1.pdf for overall instructions first. This file explains
...
1. Create a directory, `assignment1-submission/`
1. Copy your code, tests, and the package.json file into `assignment1-submission/`
1. Run eslint on your code and save the result to `assignment1-submission/eslint.log`
1. Create `assignment1-submission.zip` from the contents of `assignment1-submission/*`

You can upload and submit the `assignment1-submission.zip` to Blackboard.
