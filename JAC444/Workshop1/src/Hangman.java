...
public class Hangman {
    ...
    private static void play (){ /* your code here */
    ...
    /* Find first empty position in array of entered letters (one with code \u0000) // null character */
    ...
    private static boolean askPlayAgain(Scanner input) {
        ...
        // if they enter neither Y or N, what do you do?
        // I choose to just let anything other than Y mean false.
